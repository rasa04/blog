          ...
          <div class="col-12">
            <form action="{{ route('admin.post.update', $post) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="w-25 mb-2">
                  <!-- можно испольлзовать как asset() так и url() -->
                ...
                <div class="input-group w-50">
                  ...
                  <div class="input-group-append">
                    <span class="input-group-text text-success">Загрузить</span>
                  </div>
                </div>
                @error('preview_image')
              ...
              <div class="form-group">
                <label>Теги</label>
                <select name="tag_ids[]" class="select2" multiple="multiple" data-placeholder="Выберете теги" style="width: 100%;">
                  @foreach($tags as $tag)
                    <option 
